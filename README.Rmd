...
The models should be link all blocks.

You can apply bootstraping to the models with `search_model`, 
then `iterate_model` or bootstap the samples with `boot_samples_sgcca` and `boot_index_sgcca`.
...
The AVE scores is for each bootrap sample, which help to decide which is the stability of the model.
